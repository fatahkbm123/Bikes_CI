   ...
   $.ajax({
      ...
      success: (data) => {
         ...
         if (data == 0) {
            ...
            $('.parentHover').html(
               '<div class="contentHover"><div class="header"><p>Baru saja di tambahkan!</p></div><div class="uyu"></div><div class="Btn"><a href="http://localhost/Bikes_CI/Cart" class="btn btn-outline-danger d-block CekKeranjang">Check Keranjang</a></div></div>'
            );
         }
